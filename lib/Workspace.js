...
class Workspace extends Configurable {
    ...
    constructor ({ root=null, sources=null, branches=null }) {
        ...
        // flag programmatic construction so the engine dispatcher knows this
        // workspace's config is not readable from the tree (lib/RustEngine.js)
        this.hasPhantomSources = Boolean(sources);
